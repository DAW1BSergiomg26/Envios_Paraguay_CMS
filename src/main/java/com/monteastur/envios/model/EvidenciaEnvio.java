...
@Entity
@Table(name = "evidencias_envio", indexes = {
    @Index(name = "idx_evidencias_envio_id", columnList = "envio_id"),
    @Index(name = "idx_evidencias_envio_visible", columnList = "envio_id, visible_cliente")
})
